...
const IGNORE_PATHS = ['scripts/global', 'instructions', 'research', 'docs/howto', 'raw', 'planning', 'wiki/concepts', 'wiki/syntheses', 'wiki/wisdom', 'wiki/code', 'wiki/work-log', 'tests'];
const IGNORE_FILES = [
