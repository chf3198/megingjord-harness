...
| `fleet-advisor:obs:test` | `node --test tests/fleet-advisor-observability.spec.js tests/fleet-advisor-throughput-bench.spec.js` |
...
| `fleet-advisor:throughput-bench` | `node --test tests/fleet-advisor-throughput-bench.spec.js` |
