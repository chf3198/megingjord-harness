...
const TIP_COPY = {
  ...
  'view-fleet': ['Fleet view', 'Baton, health, activity, context flow.', 'fleet', 'use-baton'],
  'view-ops': ['Ops view', 'Quotas, router, governance, ticket log.', 'ops', 'use-quotas'],
  'view-resources': ['Resources', 'Device/service inventory cards.', 'resources', 'data'],
  ...
  'ticket-log': ['Ticket Log', 'Full audit trail of all tickets. Active first; closed/cancelled collapsed.', 'ops', 'use-ticket-log'],
  wiki: ['Wiki Health', 'Page count, coverage %, staleness metrics.', 'ops', 'views'],
  'wiki-reader': ['Wiki Reader', 'Browse and search research/ markdown pages.', 'wiki', 'views'],
  devices: ['Fleet Devices', 'Device inventory: name, Tailscale IP, RAM, OS, role.', 'resources', 'data'],
  services: ['Services', 'API service cards: endpoint, status, last checked.', 'resources', 'data'],
  config: ['Settings', 'Dashboard preferences: refresh interval, contrast, tooltips.', 'ops', 'controls'],
  'test-panel': ['Stress Test', 'Simulates 5 parallel tickets + mock events. ~60s.', 'ops', 'controls'],
